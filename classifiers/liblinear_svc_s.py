...
class LibLinear_SVC_S(AutoSklearnClassificationAlgorithm):
    # Liblinear is not deterministic as it uses a RNG inside
    def __init__(self, penalty, loss, dual, tol, C, multi_class,
                 fit_intercept, intercept_scaling, sampling_method, class_weight=None,
                 random_state=None):
    ...
    def get_hyperparameter_search_space(dataset_properties=None):
        ...
        cs.add_hyperparameters([penalty, loss, dual, tol, C, multi_class,
                                fit_intercept, intercept_scaling, sampling_method])
