...
class DecisionTree_S(AutoSklearnClassificationAlgorithm):
    def __init__(self, criterion, max_features, max_depth_factor,
                 min_samples_split, min_samples_leaf, min_weight_fraction_leaf,
                 max_leaf_nodes, min_impurity_decrease, sampling_method, class_weight=None,
                 random_state=None):
    ...
    def get_hyperparameter_search_space(dataset_properties=None):
        ...
        cs.add_hyperparameters([criterion, max_features, max_depth_factor,
                                ...
                                min_impurity_decrease, sampling_method])
